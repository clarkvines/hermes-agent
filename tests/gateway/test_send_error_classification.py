...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Slack API error: invalid_auth", "forbidden"),
        ("Slack API error: account_inactive", "forbidden"),
        ("Slack API error: token_revoked", "forbidden"),
        ("Slack API error: not_in_channel", "forbidden"),
        ("Slack API error: no_permission", "forbidden"),
        ("Slack API error: not_allowed_token_type", "forbidden"),
        ("Slack API error: is_archived", "forbidden"),
        ("Bad Request: chat not found", "not_found"),
        ("Slack API error: channel_not_found", "not_found"),
